...
class BuilderTest extends TestCase
{
    ...
    public function itMatchesRecordContentsRegardlessOfCase(): void
    {
        $builder = (new Builder('alexbouma.me'))
            ->selector(Builder::SELECTOR_CERTIFICATE)
            ->matchingType(Builder::MATCHING_TYPE_FULL);

        $expected = '3 0 0 ';

        $this->assertTrue(
            $builder->forCertificate($this->get_certificate_stub())->matchesRecordContents($expected)
        );

        $this->assertTrue(
            $builder->forCertificate(strtoupper($this->get_certificate_stub()))->matchesRecordContents(strtolower($expected))
        );

        $this->assertTrue(
            $builder->forCertificate(strtolower($this->get_certificate_stub()))->matchesRecordContents(strtoupper($expected))
        );

        $this->assertTrue(
            $builder->forCertificate(strtolower($this->get_certificate_stub()))->matchesRecordContents(strtolower($expected))
        );

        $this->assertTrue(
            $builder->forCertificate(strtoupper($this->get_certificate_stub()))->matchesRecordContents(strtoupper($expected))
        );
    }
